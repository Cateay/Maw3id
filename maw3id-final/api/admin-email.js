...
module.exports = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      console.error('Email history logging error:', logError);
    }

    return res.status(200).json({ success: true, message: 'تم إرسال البريد بنجاح.', id: result?.data?.id || result?.id || null });
  } catch (error) {
