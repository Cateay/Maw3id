...
const supabase=()=>createClient(process.env.SUPABASE_URL,process.env.SUPABASE_SECRET_KEY||process.env.SUPABASE_SERVICE_ROLE_KEY);const resend=()=>process.env.RESEND_API_KEY?new Resend(process.env.RESEND_API_KEY):null;
